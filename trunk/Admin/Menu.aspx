<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="Admin.master" CodeFile="Menu.aspx.cs" Inherits="Admin_Menu" %>
...
<asp:Content runat="server" ContentPlaceHolderID="title">Menu Manager</asp:Content>
...
<asp:Content runat="server" ContentPlaceHolderID="Maincontent">
    ...
    <div class="onecolumn">
        <div class="header">
            <span><span class="ico  gray random"></span>Menu manager </span>
        </div>
        <!-- End header -->
        <div class=" clear">
        </div>
        <div class="content">
            ...
            <div class="tableName">
                ...
                <asp:GridView runat="server" ID="grvMenu" AutoGenerateColumns="False" CssClass="display data_table2">
                    <Columns>
                        ...
                        <asp:TemplateField runat="server">
                            ...
                            <HeaderTemplate>
                                Url</HeaderTemplate>
                            <ItemTemplate>
                                <a href="<%# rewriteUrl(Eval("url").ToString(),Convert.ToBoolean(Eval("typeUrl").ToString())) %>"><%# Eval("name") %></a>
                        ...
                        <asp:TemplateField runat="server">
                            ...
                            <ItemTemplate>
                                <a class="iconBox color" href="EditMenu.aspx?id=<%#Eval("menu_id") %>" original-title="Update" style="width: 30px">
                                    <img src="images/icon/color_18/diskette.png" alt="Update">
                                </a>
                                <a class="iconBox color delete_menu" id="<%# Eval("menu_id") %>" original-title="Delete" style="width: 30px">
