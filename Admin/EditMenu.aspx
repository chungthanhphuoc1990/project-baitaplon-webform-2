<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="Admin.master" CodeFile="EditMenu.aspx.cs" Inherits="Admin_EditMenu" %>

<asp:Content runat="server" ContentPlaceHolderID="meta">
    <meta name="description" content="Menu manager" />
    <meta name="keywords" content="Menu manager" />
</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="title">Edit Menu</asp:Content>
...
<asp:Content runat="server" ContentPlaceHolderID="Maincontent">
    ...
    <div class="onecolumn">
        <div class="header">
            <span><span class="ico  gray random"></span>Edit Menu </span><a class="uibutton icon prev" style="margin: 5px 0px 0px 20px" href="Menu.aspx">Back</a>
                        ...
                        <div class="da-form-inline">
                            <div class="section da-form-row textonly large">
                                ...
                                <div class="da-form-item large ">
                                    <asp:TextBox runat="server" ID="txtName" CssClass="large autourl" ></asp:TextBox>
                                </div>
                            </div>
                            <div class="section da-form-row large">
                                <label>Type Url:</label>
                                <div class="da-form-item large typeurl">
                                    <div>
                                        <asp:RadioButton GroupName="url" runat="server" ID="type_1" CssClass="ck typeurl_1" Checked="True"/>
                                          
                                          <label for="radio_1">Url Relative</label>
                                      </div>
                                      <div>
                                          <asp:RadioButton GroupName="url" runat="server" ID="type_2" CssClass="ck typeurl_2"/>
                                          <label for="radio_2" >URL Absolute</label>
                                          <span class="f_help">Url có dang: http://www.google.com.vn </span>
                                      </div>
                                </div>
                            </div>
                            <div class="section da-form-row large url">
                                <label>Url:</label>
                                <div class="da-form-item large">
                                    <asp:TextBox runat="server" ID="txtUrl" CssClass="large urlauto"></asp:TextBox>
                                </div>
                            </div>
                            
                            <div class="section da-form-row numericonly large">
                                <label>Order:</label>
                                <div class="da-form-item small">
                                    <asp:TextBox runat="server" ID="txtOrder" CssClass="small"></asp:TextBox>
                                </div>
                            </div>
