<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="Admin.master" CodeFile="AddMenu.aspx.cs" Inherits="Admin_AddMenu" %>
...
<asp:Content runat="server" ContentPlaceHolderID="title">Add Menu</asp:Content>
...
<asp:Content runat="server" ContentPlaceHolderID="Maincontent">
    ...
    <div class="onecolumn">
        <div class="header">
            <span><span class="ico  gray random"></span>Add Menu </span><a class="uibutton icon prev" style="margin: 5px 0px 0px 20px" href="Menu.aspx">Back</a>
                        ...
                        <div class="da-form-inline">
                            <div class="section da-form-row textonly large">
                                ...
                                <div class="da-form-item large ">
                                    <asp:TextBox runat="server" ID="txtName" CssClass="large autourl" 
